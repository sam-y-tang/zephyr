...
The heltec_wifi_lora32_v3 is an entry-level development board equipped with either ESP32-S3-MINI-1
or ESP32-S3-MINI-1U, a module named for its small size. This board integrates complete Wi-Fi
and Bluetooth Low Energy functions. For more information, check `ESP32-S3 `_
...
heltec_wifi_lora32_v3 includes the following features:
...
Current Zephyr's heltec_wifi_lora32_v3 board supports the following features:
